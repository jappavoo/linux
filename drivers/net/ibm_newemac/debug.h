...
#define EMAC_DBG(dev, name, fmt, arg...) \
	printk(#name "%s: " fmt, dev->ofdev->node->full_name, ## arg)
...
#  define XGMII_DBG(d,f,x...)	EMAC_DBG(d, rgmii, f, ##x)
#  define NL			"\n"
#else
