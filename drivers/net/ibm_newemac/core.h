...
/* Simple sanity check */
#if !defined(CONFIG_IBM_NEW_EMAC_TOMAL) && (NUM_TX_BUFF > 256 || NUM_RX_BUFF > 256)
...
/*
 * Set if we have and XEMAC
 */
#define EMAC_FTR_XEMAC			0x00000080
/*
 * Set if we have a SGMII
 */
#define EMAC_FTR_HAS_SGMII		0x00000100
/*
 * Set if we have a XGMII
 */
#define EMAC_FTR_HAS_XGMII		0x00000200
/*
 * Set if we have indirect STACR
 */
#define EMAC_FTR_INDIRECT_STACR		0x00000400
...
enum {
	...
	EMAC_FTRS_POSSIBLE	=
...
#endif
#ifdef CONFIG_IBM_NEW_EMAC_XEMAC
	    EMAC_FTR_XEMAC	| EMAC_FTR_INDIRECT_STACR	|
	    EMAC_FTR_STACR_OC_INVERT	| EMAC_FTR_HAS_AXON_STACR |
#endif
	    ...
	    EMAC_FTR_HAS_RGMII	|
#endif
#ifdef CONFIG_IBM_NEW_EMAC_SGMII
	    EMAC_FTR_HAS_SGMII	|
#endif
...
#define EMAC_ETHTOOL_REGS_XGMII		0x00000008
