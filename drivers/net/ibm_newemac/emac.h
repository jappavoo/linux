...
#define XEMAC_MR1_SDR			0x80000000 /* Single data rate */
#define XEMAC_MR1_LPEN			0x40000000 /* loopback */
#define XEMAC_MR1_VLEN			0x20000000 /* vlan enable */
#define XEMAC_MR1_IFEN			0x10000000 /* integrated flow control */
#define XEMAC_MR1_PSEN			0x08000000 /* pause frame */
#define XEMAC_MR1_RFS_2K		0x00100000
#define XEMAC_MR1_RFS_4K		0x00180000
#define XEMAC_MR1_RFS_8K		0x00200000
#define XEMAC_MR1_RFS_16K		0x00280000
#define XEMAC_MR1_RFS_32K		0x00300000
#define XEMAC_MR1_RFS_64K		0x00380000
#define XEMAC_MR1_TFS_2K		0x00020000
#define XEMAC_MR1_TFS_4K		0x00030000
#define XEMAC_MR1_TFS_8K		0x00040000
#define XEMAC_MR1_TFS_16K		0x00050000
#define XEMAC_MR1_TFS_32K		0x00060000
#define XEMAC_MR1_TFS_64K		0x00070000
#define XEMAC_MR1_TRQ			0x00008000 /* single/multi packet */
#define XEMAC_MR1_MWSW_001		0x00001000
#define XEMAC_MR1_JBEN			0x00000800
#define XEMAC_MR1_OBCI_50		0x00000000
#define XEMAC_MR1_OBCI_66		0x00000008
#define XEMAC_MR1_OBCI_83		0x00000010
#define XEMAC_MR1_OBCI_100		0x00000018
#define XEMAC_MR1_OBCI_133		0x00000020
#define XEMAC_MR1_OBCI(freq)		((freq) <= 50  ? XEMAC_MR1_OBCI_50 : \
					 (freq) <= 66  ? XEMAC_MR1_OBCI_66 : \
					 (freq) <= 83  ? XEMAC_MR1_OBCI_83 : \
					 (freq) <= 100 ? XEMAC_MR1_OBCI_100 : \
						XEMAC_MR1_OBCI_133)
...
#define XEMAC_TMR0_DEFAULT		EMAC4_TMR0_TFAE_128_2048
#define EMAC_TMR0_XMIT			(EMAC_TMR0_GNP | EMAC_TMR0_DEFAULT)
#define EMAC4_TMR0_XMIT			(EMAC_TMR0_GNP | EMAC4_TMR0_DEFAULT)
#define XEMAC_TMR0_XMIT			(EMAC_TMR0_GNP | XEMAC_TMR0_DEFAULT)

/* EMACx_TMR1 */

#define EMAC_TMR1(l,h)			(((l) << 27) | (((h) & 0xff) << 16))
#define EMAC4_TMR1(l,h)			(((l) << 27) | (((h) & 0x3ff) << 14))
#define XEMAC_TMR1(l,h)			(((l) << 21) | (((h) & 0x7ff) << 5))
...
#define XEMAC_RMR_PUME			0x00080000
#define XEMAC_RMR_SIAE			0x00040000
#define XEMAC_RMR_BASE			EMAC4_RMR_RFAF_128_2048
